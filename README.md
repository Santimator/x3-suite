...
from the couch; tidy the SD card — make a folder, tick several books and move
them into it; see the font families the reader actually holds and select,
rename or delete one there. Books, wallpapers and fonts each get a card listing what this
