...
(`.claude/skills/` symlinks all four.)
...
- Feed markup → the opds-server selftest's oracle is a port of the device's own OPDS client. Valid OPDS ≠ readable by this device.
